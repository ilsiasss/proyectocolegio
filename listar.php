...
$sentencia = $base_de_datos->query("select id, nombre,apellido,direccion, edad from estudiante");
		...
		<div class="table-responsive">
			<table class="table table-bordered">
				...
				<tbody>
					...
					-->
					<?php foreach($estudiante as $mascota){ ?>
						<tr>
							<td><?php echo $mascota->id ?></td>
							<td><?php echo $mascota->nombre ?></td>
							<td><?php echo $mascota->apellido ?></td>
							<td><?php echo $mascota->direccion ?></td>
